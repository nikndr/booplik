...
Triangle::Triangle(const double x1, const double y1, const double x2, const double y2, const double x3, const double y3)
		...
		_ca(nullptr), _heightA(_a, _baseA), _heightB(_b, _baseB), _heightC(_c, _baseC)
{
}

Triangle::Triangle(const Point &a, const Point &b, const Point &c) :
		_a(a), _b(b), _c(c), _baseA(0, 0), _baseB(0, 0), _baseC(0, 0), _ab(nullptr), _bc(nullptr), _ca(nullptr),
		_heightA(_a, _baseA), _heightB(_b, _baseB), _heightC(_c, _baseC)
{
}
...
Triangle::Triangle(const Triangle &t) :
		...
		_ab(nullptr),
		_bc(nullptr), _ca(nullptr), _heightA(_a, _baseA), _heightB(_b, _baseB), _heightC(_c, _baseC)
{
}
